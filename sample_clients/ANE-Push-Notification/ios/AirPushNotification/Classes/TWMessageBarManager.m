...
+ (void)initialize
{
	if (self == [TWDefaultMessageBarStyleSheet class])
	{
        ...
        kTWDefaultMessageBarStyleSheetSuccessBackgroundColor = [UIColor colorWithRed:0.49 green:0.60 blue:0.38  alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // green
        ...
        kTWDefaultMessageBarStyleSheetSuccessStrokeColor = [UIColor colorWithRed:0.29 green:0.36 blue:0.20 alpha:1.0f]; // green
