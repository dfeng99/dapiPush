...
This is an [Air native extension](http://www.adobe.com/devnet/air/native-extensions-for-air.html) for sending push notifications on iOS and Android.
...
The Derivative Works of this ANE has been written by David Feng (https://github.com/dfeng99) as the sample client for DapiPush push notification gateway (https://plus.google.com/u/1/communities/116623247943851417179).

This ANE has been originally written by [Thibaut Crenn](https://github.com/titi-us). It belongs to [FreshPlanet Inc.](http://freshplanet.com) and is distributed under the [Apache Licence, version 2.0](http://www.apache.org/licenses/LICENSE-2.0). 
